...
WHITEBOOKS_GSTR2B_POLL_MAX_ATTEMPTS = env.int("WHITEBOOKS_GSTR2B_POLL_MAX_ATTEMPTS", default=5)
WHITEBOOKS_GSTR2B_POLL_BASE_DELAY_SECONDS = env.int("WHITEBOOKS_GSTR2B_POLL_BASE_DELAY_SECONDS", default=60)
WHITEBOOKS_GSTR2B_POLL_MAX_DELAY_SECONDS = env.int("WHITEBOOKS_GSTR2B_POLL_MAX_DELAY_SECONDS", default=600)
...
WHITEBOOKS_ENABLE_GSTR7_SAVE_LIVE = env.bool("WHITEBOOKS_ENABLE_GSTR7_SAVE_LIVE", default=False)
WHITEBOOKS_ENABLE_GSTR7_FILE_LIVE = env.bool("WHITEBOOKS_ENABLE_GSTR7_FILE_LIVE", default=False)
WHITEBOOKS_ENABLE_GSTR9_SAVE_LIVE = env.bool("WHITEBOOKS_ENABLE_GSTR9_SAVE_LIVE", default=False)
WHITEBOOKS_ENABLE_GSTR9_FILE_LIVE = env.bool("WHITEBOOKS_ENABLE_GSTR9_FILE_LIVE", default=False)
WHITEBOOKS_ENABLE_GSTR9C_SAVE_LIVE = env.bool("WHITEBOOKS_ENABLE_GSTR9C_SAVE_LIVE", default=False)
WHITEBOOKS_ENABLE_GSTR9C_FILE_LIVE = env.bool("WHITEBOOKS_ENABLE_GSTR9C_FILE_LIVE", default=False)
...
WHITEBOOKS_ENABLE_LEDGER_READS = env.bool("WHITEBOOKS_ENABLE_LEDGER_READS", default=False)
WHITEBOOKS_ENABLE_PAYMENT_READS = env.bool("WHITEBOOKS_ENABLE_PAYMENT_READS", default=False)
WHITEBOOKS_ENABLE_CHALLAN_GENERATION = env.bool("WHITEBOOKS_ENABLE_CHALLAN_GENERATION", default=False)
WHITEBOOKS_ENABLE_PROVIDER_SUMMARY_READS = env.bool("WHITEBOOKS_ENABLE_PROVIDER_SUMMARY_READS", default=False)
WHITEBOOKS_NOTICE_SYNC_ENABLED = env.bool("WHITEBOOKS_NOTICE_SYNC_ENABLED", default=False)
WHITEBOOKS_NOTICE_SYNC_SCHEDULE_HOUR = env.int("WHITEBOOKS_NOTICE_SYNC_SCHEDULE_HOUR", default=8)
WHITEBOOKS_NOTICE_SYNC_SCHEDULE_MINUTE = env.int("WHITEBOOKS_NOTICE_SYNC_SCHEDULE_MINUTE", default=30)
PROVIDER_SUMMARY_COMPARE_THRESHOLD_AMOUNT = env("PROVIDER_SUMMARY_COMPARE_THRESHOLD_AMOUNT", default="1.00")
