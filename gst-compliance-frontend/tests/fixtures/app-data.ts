...
export function createNotice(overrides: Partial<Record<string, unknown>> = {}) {
  return {
    ...
    provider_status: "",
    provider_due_date: null,
    provider_payload: {},
    provider_detail_payload: {},
    provider_synced_at: null,
    provider_detail_synced_at: null,
    provider_last_error: "",
    assigned_to: 21,
...
export function createNoticeSyncEvent(overrides: Partial<Record<string, unknown>> = {}) {
  return {
    id: "notice-sync-event-1",
    gstin: "gstin-1",
    gstin_value: "27ABCDE1234F1Z5",
    client_id: "client-1",
    client_name: "Acme Client Private Limited",
